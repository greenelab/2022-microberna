...
and from https://github.com/bluegenes/2021-rank-compare/blob/main/genbank_genomes.py
"""
import sys
import argparse
...
def url_for_accession(accession):
    ...
    if full_name is None:
        ...
        return (
            ...
            f"{url}/{full_name}/{full_name}_genomic.gff.gz",
            f"{url}/{full_name}/{full_name}_cds_from_genomic.fna.gz",
...
def main(args):
    fieldnames = ["acc", "genome_url", "gff_url", "cds_url", "assembly_report_url", "ncbi_tax_name", "ncbi_taxid"]
    if args.output:
    ...
    genome_url, gff_url, cds_url, assembly_report_url = url_for_accession(acc)
